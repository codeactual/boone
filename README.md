...
boone runs commands based on file-activity. It started as a personal CI tool, so its approach is heavily biased toward that use case even if the configuration options appear general purpose.
